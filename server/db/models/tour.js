...
module.exports = (sequelize, DataTypes) => {
  class Tour extends Model {
    static associate({ User, Comment, CategoryTour, Favorite }) {
      // this.belongsToMany(User, { through: Favorite, foreignKey: 'tourId', as: 'favorites' });
      this.hasMany(Favorite, { foreignKey: 'tourId', as: 'favorites'});
